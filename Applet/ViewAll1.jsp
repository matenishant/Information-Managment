...
<html>
  <head>
    ...
    <title>My JSP 'ViewAll1.jsp' starting page</title>
...
<%
 ...
 %>
			 ...
			 <div id=form-head style="width:100%; float:left; height: 100px;"> 
	...
	<%
	    ...
	    while(res.next())
		{
			...
			String s16=res.getString(16);
			 ...
			 //out.println("<td><a href=conf1.jsp?id2="+s1+">Confirm</a></td>");
			 //out.println("<td><a href=notconf1.jsp?id2="+s1+">Not Confirm</a></td>");			 			 
			 out.println("<td><a href=Adminupdate1.jsp?id2="+s1+">Update</a></td>");
			 
			  out.println("<td><a href=delete.jsp?id3="+s1+">Delete</a></td>");
