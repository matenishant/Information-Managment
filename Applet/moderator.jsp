...
<div id='main'>
			 ...
			 <div id=head-mid style="width: 80%; float:left;"> 
				 <h2 id=heading align='left' style="padding-left:20px;">Support Panel</h2> </div>
 ...
 %>
	...
	<li> <a href="ViewAll2.jsp"><h4>Call receive by agents</h4></a>
	<li> <a href="enquiry.jsp"><h4>New Client Enquiry Form</h4></a>
	<li> <a href="ViewAll.jsp"><h4>View All Visitors Information with Payment details</h4></a>
