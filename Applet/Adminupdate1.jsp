...
<center>
	...
	<%
	   ...
	   String name="", email="", phone="", remote="", address="", country="", state="", city="", pur_date="",raise_ticket="",issue="", mode="",amt="", bank="", status="";
	    ...
	    while(res.next())
		{
			 ...
			 raise_ticket= res.getString("raise_ticket");
	...
	<br />	
		...
		<form onsubmit="return checkForm(this);" action="update.jsp"  >
		 ...
		 <p style="color:blue; margin-bottom:0px; margin-top:20px;"> Remote ID<br /></p>
						<button class='bt' style='background-image:url(images/reg/icon-name.png); ' disabled="disabled"></button> 
						 <input type='text' id='refer' name='remote' class='tf' value="<%=remote%>" required/>			<br /><br /> 
								</center></div>
		...
		<script language="javascript">print_country("country");</script> -->
		 ...
		 <input type='text' onfocus="this.type='text'" onblur= "this.type ='text'" name='raise_ticket' class='tf' placeholder='Close By' required value="<%= raise_ticket %>" /><br /><br /> 
		...
		function selection()
		{
			...
			<input type="radio" id="cash" name='mode' style="margin-left: 10px;" value="debit" onclick="selection()"  <%if(mode.equalsIgnoreCase("cash")){ %>checked<%} %>/>  Debit
		<input type="radio" id="cheque" name='mode' style="margin-left: 40px;" onclick="selection()" value="credit" <%if(mode.equalsIgnoreCase("cheque")){ %>checked<%} %>/> Credit
	<input type="radio" id="online" name='mode' style="margin-left: 30px;" onclick="selection()"  value="wire" <%if(mode.equalsIgnoreCase("online")){ %>checked<%} %>/> Wire
	...
	<!-- <div id="trans-div" style="width:400px; height:50px; visibility:hidden;"><center>
		 ...
		 <input type='text' name='amt' class='tf' placeholder='Total Amount' value="<%= amt%>"  required/>			<br /><br /> 
		</center></div>
		
		<div id="cheq-div" style="width:400px; height:50px;"><center>
		 <p style="color:blue; margin-bottom:0px; margin-top:20px;"> Status <br /></p>
		<button class='bt' id='cheq-bt' style='background-image:url(images/reg/rs1.png); ' disabled="disabled"></button> 
		 <input type='text' id="cheq" name='status' class='tf' placeholder='Open/Close'  value="<%= status%>"/>			<br /><br /> 
		 </center></div>
		 ...
		 <input type='text' id="bank" name='bank' class='tf' placeholder='Bank' value="<%= bank%>" />			<br /><br /> 
				 ...
				 <input type="submit" style="border:outset;" value="Update"/>
